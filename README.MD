...
![tests](https://img.shields.io/badge/tests-215_passed-brightgreen)
...
| Package                 | Description                                                                                    |
| ----------------------- | ---------------------------------------------------------------------------------------------- |
| `@transferx/sdk`        | **Start here.** High-level façade — `createB2Engine()`, `createS3Engine()`, `createR2Engine()` |
...
│  createR2Engine()  ·  makeUploadSession()           │
└───────────────────────┬─────────────────────────────┘
                        │
┌───────────────────────▼─────────────────────────────┐
│                  UploadEngine                       │
